---
title: "q12 'If you had to live with some pain, what level of pain would be acceptable?' (MA Veterans)"
author: "David Ritter"
...
q12_ma_n <- length(unique(q12_all$id))
```
...
q12_plot <- 
  ...
  mutate(percent_responded = count / q12_ma_n)
```

```{r}
# Plot with percents and response counts
r <- 
  ggplot(q12_plot, aes(x = reorder(response.x, count), y = percent_responded)) +
...
write.csv(q12_plot, 'q12_acceptable_pain_57.csv', row.names = FALSE)
