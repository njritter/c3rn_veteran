...
write.csv(q_plot, 'output/q77_wars_served_143.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q77_wars_served.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q77_wars_served_231.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q77_wars_served_ids.csv', row.names = FALSE)
```
