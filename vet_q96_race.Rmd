...
ggsave(filename = 'vet_q96_race.png', plot = r, device = 'png')

write.csv(Q96_plot, 'vet_q96_race_144.277.csv', row.names = FALSE)

write.csv(Q96_all, 'vet_q96_race_ids.csv', row.names = FALSE)
```
