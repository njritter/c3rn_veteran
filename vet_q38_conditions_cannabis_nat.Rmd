---
title: "q38 'Which health conditions do you find cannabis to be helpful in treating? (Please select all that apply)' (National Veterans)"
author: "DJ"
...
write.csv(q38_plot, 'q38_conditions_cannabis_431.csv', row.names = FALSE)
