...
write.csv(q_plot, 'output/q20_prescriptions_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q20_prescriptions.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q20_prescriptions_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q20_prescriptions_ids.csv', row.names = FALSE)
```
