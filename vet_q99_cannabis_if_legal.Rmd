...
ggsave(filename = 'q99_med_cannabis_research.png', plot = r, device = 'png')

write.csv(q99_plot, 'q99_med_cannabis_research_161.csv', row.names = FALSE)

write.csv(q99_all, 'q99_med_cannabis_research_ids.csv', row.names = FALSE)
