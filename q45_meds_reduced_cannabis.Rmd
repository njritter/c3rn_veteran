...
r <- 
  ...
  labs(title = "What prescription medications are you currently taking for the health conditions and symptoms you face that you are actively trying to reduce the use of by using cannabis? (Please select all that apply)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q45_meds_reduced_cannabis_217.csv', row.names = FALSE)
