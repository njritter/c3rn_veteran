...
Q89_healing_rose <- get_single_selection(data = raw_data_healing_rose, q.name = Q89)

Q89_all <- rbind(Q89_general, Q89_bask, Q89_botanist, Q89_healing_rose)
...
ggsave(filename = 'vet_q89_gender.png', plot = r, device = 'png')

write.csv(Q89_plot, 'vet_q89_gender_141_277.csv', row.names = FALSE)

write.csv(Q89_all, 'vet_q89_gender_ids.csv', row.names = FALSE)
```
