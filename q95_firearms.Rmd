...
r <- 
  ...
  labs(title = "Do you own a firearm?", subtitle = q_n)
r
```

```{r}
# Save graph as PNG, plot data as csv, and all question data including response IDs as csv (save question n and N at end of plot file as "_x.x")
ggsave(filename = 'q95_firearms.png', plot = r, device = 'png')

write.csv(q_plot, 'q95_firearms_217.csv', row.names = FALSE)

write.csv(q_data, 'q95_firearms_ids.csv', row.names = FALSE)
```
