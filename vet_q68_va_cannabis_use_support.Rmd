---
title: "Q68 VA Cannabis Use Support (Veterans)"
author: "DJ"
date: "June 26, 2019"
...
ggsave(filename = 'vet_q68_va_cannabis_use_support.png', plot = r, device = 'png')

write.csv(Q68_plot, 'vet_q68_va_cannabis_use_support_76.167.csv', row.names = FALSE)

write.csv(Q68_all, 'vet_q68_va_cannabis_use_support_ids.csv', row.names = FALSE)
```