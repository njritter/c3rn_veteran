...
write.csv(q_plot, 'output/q37_cannabis_uses_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q37_cannabis_uses.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q37_cannabis_uses_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q37_cannabis_uses_ids.csv', row.names = FALSE)
```
