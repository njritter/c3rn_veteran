---
title: "Q68 VA Support Cannabis (Nat Veterans)"
author: "DJ"
date: "July 29, 2019"
...
Q68_all <- rbind(Q68_general, Q68_bask, Q68_botanist, Q68_healing_rose)
...
ggsave(filename = 'vet_q68_va_support_cannabis.png', plot = r, device = 'png')

write.csv(Q68_plot, 'vet_q68_va_support_cannabis_342.csv', row.names = FALSE)

write.csv(Q68_all, 'vet_q68_va_support_cannabis_ids.csv', row.names = FALSE)
```