...
write.csv(q_plot, 'output/q47_cannabis_methods_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q47_cannabis_methods.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q47_cannabis_methods_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q47_cannabis_methods_ids.csv', row.names = FALSE)
```
