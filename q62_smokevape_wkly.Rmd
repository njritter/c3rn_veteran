...
write.csv(table_1, 'q62_flower_wkly_88.csv', row.names = FALSE)

ggsave(filename = 'q62_vape_wkly.png', plot = r2, device = 'png')
write.csv(table_2, 'q62_vape_wkly_27.csv', row.names = FALSE)

ggsave(filename = 'q62_concentrates_wkly.png', plot = r3, device = 'png')
write.csv(table_3, 'q62_concentrates_wkly_40.csv', row.names = FALSE)
```
