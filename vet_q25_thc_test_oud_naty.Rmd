---
title: "q25 'Have you ever been tested for THC (marijuana) during your opioid recovery treatment?' (National Veterans)"
author: "DJ"
...
q25_n <- length(unique(q25_all$id))
```
...
q25_plot <- 
  ...
  mutate(percent_responded = count / q25_n)
```
...
write.csv(q25_plot, 'q25_thc_test_oud_7.csv', row.names = FALSE)
