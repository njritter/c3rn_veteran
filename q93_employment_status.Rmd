...
r <- 
  ...
  labs(title = "What is your current employment status?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q93_employment_status_217.csv', row.names = FALSE)

write.csv(q_data, 'q93_employment_status_ids.csv', row.names = FALSE)
```