...
```{r}
# Pull out all responses for Q77 (a choose all question), combine, and turn
...
write.csv(for_plot, 'Q77_Wars_Served_146.277.csv', row.names = FALSE)
