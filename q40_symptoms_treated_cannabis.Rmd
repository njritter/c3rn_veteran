...
write.csv(q_plot, 'output/q40_symptoms_treated_cannabis_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q40_symptoms_treated_cannabis.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q40_symptoms_treated_cannabis_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q40_symptoms_treated_cannabis_ids.csv', row.names = FALSE)
```
