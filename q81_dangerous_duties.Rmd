...
r <- 
  ...
  labs(title = "Did you ever go on combat patrols or have other dangerous duty?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q81_dangerous_duty_90.csv', row.names = FALSE)

write.csv(q_data, 'q81_dangerous_duty_ids.csv', row.names = FALSE)
```
