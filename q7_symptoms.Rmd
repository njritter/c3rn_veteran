...
write.csv(q_plot, 'output/q7_symptoms_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q7_symptoms.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q7_symptoms_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q7_symptoms_ids.csv', row.names = FALSE)
```
