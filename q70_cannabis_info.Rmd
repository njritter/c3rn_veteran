...
write.csv(q_plot, 'output/q70_cannabis_info_130.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q70_cannabis_info.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q70_cannabis_info_216.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q70_cannabis_info_ids.csv', row.names = FALSE)
```
