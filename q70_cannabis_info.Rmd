...
r <- 
  ...
  labs(title = "Where do you get your information to make informed decisions about cannabis products? (Please select all that apply)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q70_cannabis_info_202.csv', row.names = FALSE)

write.csv(q_data, 'q70_cannabis_info_ids.csv', row.names = FALSE)
```
