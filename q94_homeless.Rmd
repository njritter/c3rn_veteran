...
r <- 
  ...
  labs(title = "Have you ever been homeless?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q94_homeless_217.csv', row.names = FALSE)

write.csv(q_data, 'q94_homeless_ids.csv', row.names = FALSE)
```
