...
q45_hr <- get_choose_all(raw_data_hr, q.name = q45, f.response = q45_final_response)

names(q45_hr) <- names(q45_general)

q45_all <- 
  rbind(q45_general, q45_botanist, q45_bask, q45_hr) %>%
  tidy_choose_all()
...
write.csv(q45_plot, 'q45_meds_reduced_cannabis_378.csv', row.names = FALSE)

write.csv(Q45_all_reduce, 'q45_meds_reduced_cannabis_ids.csv', row.names = FALSE)
```
