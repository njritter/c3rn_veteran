---
title: "Q5 Top Condition Cannabis (Rev)"
author: "DJ"
date: "June 26, 2019"
...
Q5_all <- get_single_selection(data = raw_data_rev, q.name = Q5)
...
ggsave(filename = 'rev_q5_top_condition_cannabis.png', plot = r, device = 'png')

write.csv(Q5_plot, 'rev_q5_top_condition_cannabis_140.166.csv', row.names = FALSE)

write.csv(Q5_all, 'rev_q5_top_condition_cannabis_ids.csv', row.names = FALSE)
```
