...
r <- 
  ...
  labs(title = "Which of the following best represents your ethnic heritage?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q96_race_217.csv', row.names = FALSE)

write.csv(q_data, 'q96_race_ids.csv', row.names = FALSE)
```
