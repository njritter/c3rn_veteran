...
r <- 
  ...
  labs(title = "What is your annual household income (in US dollars)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q90_income_217.csv', row.names = FALSE)

write.csv(q_data, 'q90_income_ids.csv', row.names = FALSE)
```
