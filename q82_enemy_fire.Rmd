...
r <- 
  ...
  labs(title = "Were you ever under enemy fire?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q82_enemy_fire_73.csv', row.names = FALSE)

write.csv(q_data, 'q82_enemy_fire_ids.csv', row.names = FALSE)
```
