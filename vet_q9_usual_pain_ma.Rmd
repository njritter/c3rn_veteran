---
title: "q9 'What is your usual level of pain (how does your pain feel most of the time?)' (MA Veterans)"
author: "DJ"
...
q9_m_n <- length(unique(q9_all$id))
...
q9_plot <- 
  ...
  mutate(percent_responded = count / q9_m_n)
```

```{r}
# Plot with percents and response counts
r <- 
  ggplot(q9_plot, aes(x = reorder(response.x, count), y = percent_responded)) +
...
write.csv(q9_plot, 'q9_usual_pain_59.csv', row.names = FALSE)
