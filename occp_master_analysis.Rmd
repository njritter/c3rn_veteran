...
#block this chunk out and run next chunk
...
filtered_data <- filter(master, master$WhatÂ.is.the.primary.health.condition.for.which.you.find.cannabis.to.be.helpful.or.most.impactful..Please.select.one. == "Chronic pain")
raw_data <- rbind(headers, filtered_data)
```

```{r}
#Filtering for choose all questions
#raw_data <- filter(master, master$X.6 == "Anxiety")
```
