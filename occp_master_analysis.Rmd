...
q14_data <- get_choose_all(raw_data_occp, q.name = q14, f.response = q14_final_response)
...
q15_data <- get_choose_all(raw_data_occp, q.name = q15, f.response = q15_final_response)
...
q16_data <- get_choose_all(raw_data_occp, q.name = q16, f.response = q16_final_response)
...
q17_data <- get_choose_all(raw_data_occp, q.name = q17, f.response = q17_final_response)
...
q18_data <- get_single_selection_0(data = raw_data_occp, q.name = q18) %>%
  filter(response != "")
...
q19_data <- get_single_selection_0(data = raw_data_occp, q.name = q19) %>%
  filter(response != "")
...
q21_data <- get_single_selection(data = raw_data_occp, q.name = q21)
