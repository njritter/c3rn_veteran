---
title: "q53 'On average, how much do you spend (in US dollars) on consumable cannabis products per week?' (National Veterans)"
author: "David Ritter"
...
```{r}
write.csv(q53_all, 'vet_q53_cannabis_cost_weekly_401.csv', row.names = FALSE)
```