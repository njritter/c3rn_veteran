...
ggsave(filename = 'Q39_Primary_Condition_Cannabis_Helpful_PNG.png', plot = p, device = 'png')

```
```{r}

write.csv(Q39_plot, 'Q39_Primary_Condition_Cannabis_Helpful.csv', row.names = FALSE)
