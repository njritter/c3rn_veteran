---
title: "q13 'Where are the locations of your pain (please check all that apply)' (MA Veterans)"
author: "DJ"
...
q13_ma_n <- length(unique(q13_all$id))
```
...
q13_plot <-
  ...
  mutate(percent_responded = count / q13_ma_n)
```
...
write.csv(q13_plot, 'q13_pain_locations_59.csv', row.names = FALSE)
