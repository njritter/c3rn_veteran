...
write.csv(q_plot, 'q75_service_branch_144.csv', row.names = FALSE)
write.csv(q_data, 'q75_service_branch_ids.csv', row.names = FALSE)
```
...
```{r}
ggsave(filename = 'q75_service_branch.png', plot = r, device = 'png')
write.csv(q_plot, 'q75_service_branch_n#.csv', row.names = FALSE)
write.csv(qf_data, 'q75_service_branch_ids.csv', row.names = FALSE)
```
