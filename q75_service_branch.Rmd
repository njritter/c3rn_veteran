...
r <- 
  ...
  labs(title = "Which branch of the armed services did you serve in? (Please select all that apply)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q75_service_branch_217.csv', row.names = FALSE)
