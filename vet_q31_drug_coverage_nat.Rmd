---
title: "Q31 'Do you have prescription drug coverage?' (National Veterans)"
author: "DJ"
date: "October, 2019"
...
q31_n <- length(unique(Q31_all$id))
```
...
Q31_plot <- 
  ...
  mutate(percent_responded = count / q31_n)
```
...
write.csv(Q31_plot, 'q31_drug_coverage_431.csv', row.names = FALSE)
