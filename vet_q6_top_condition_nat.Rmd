...
ggsave(filename = 'vet_q6_top_condition.png', plot = r, device = 'png')

write.csv(Q6_plot, 'vet_q6_top_condition_372.csv', row.names = FALSE)

write.csv(Q6_all, 'vet_q6_top_condition_ids.csv', row.names = FALSE)
```
