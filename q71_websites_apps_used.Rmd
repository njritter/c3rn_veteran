...
write.csv(q_plot, 'q71_websites_apps_used_130.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'q71_websites_apps_used.png', plot = r, device = 'png')
write.csv(q_plot, 'q71_websites_apps_used_n#.csv', row.names = FALSE)
write.csv(qf_data, 'q71_websites_apps_used_ids.csv', row.names = FALSE)
```
