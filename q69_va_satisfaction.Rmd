...
r <- 
  ...
  labs(title = "How satisfied are you with the VA in managing your health condition?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q69_va_satisfaction_202.csv', row.names = FALSE)

write.csv(q_data, 'q69_va_satisfaction_ids.csv', row.names = FALSE)
```