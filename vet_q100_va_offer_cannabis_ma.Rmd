...
qxx <- "Which.US.state.do.you.currently.live.in."
...
q98_botanist <- get_single_selection(data = raw_data_botanist, q.name = qxx)
...
write.csv(q100_plot, 'q100_va_offer_cannabis_161.csv', row.names = FALSE)
