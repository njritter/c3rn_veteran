---
title: "Q10 Prescriptions Reduced Cannabis (Rev)"
author: "DJ"
date: "June 26, 2019"
...
Q10_all <- get_choose_all(raw_data_rev, q.name = Q10, f.response = Q10_final_response)
...
ggsave(filename = 'rev_q10_prescriptions_reduced_cannabis.png', plot = r, device = 'png')

write.csv(Q10_plot, 'rev_q10_prescriptions_reduced_cannabis_141.166.csv', row.names = FALSE)

write.csv(Q10_clean, 'rev_q10_prescriptions_reduced_cannabis_ids.csv', row.names = FALSE)
```