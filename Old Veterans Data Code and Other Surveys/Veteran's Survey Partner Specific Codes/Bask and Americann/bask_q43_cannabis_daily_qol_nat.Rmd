---
title: "Q43 Cannabis Daily QOL (Bask)"
author: "DJ"
date: "August 8, 2019"
...
ggsave(filename = 'bask_q43_cannabis_daily_qol.png', plot = r, device = 'png')

write.csv(Q43_plot, 'bask_q43_cannabis_daily_qol_16.csv', row.names = FALSE)

write.csv(Q43_all, 'bask_q43_cannabis_daily_qol_ids.csv', row.names = FALSE)
```