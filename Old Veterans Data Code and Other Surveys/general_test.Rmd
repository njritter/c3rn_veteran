...
```{r}
# Read in raw data from the general survey. These are the files downloaded from survey monkey saved as a .csv
...
ggsave(filename = 'general_q61_barriers.png', plot = r, device = 'png')

write.csv(Q61_plot, 'general_q61_barriers_17.csv', row.names = FALSE)

write.csv(Q61_all, 'general_q61_barrers_ids.csv', row.names = FALSE)
```
