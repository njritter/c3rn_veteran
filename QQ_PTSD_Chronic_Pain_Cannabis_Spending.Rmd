...
Q53_all <- rbind(Q53_general, Q53_bask, Q53_botanist, Q53_healing_rose)

Q53_respondents <- length(unique(Q53_all$id))
``` 

```{r}
# Load and run Q6 File and generate Q6_Chronic_Pain_ids_we_want
Q6_Chronic_Pain_ids_we_want

Q53_responses_we_want <- Q53_all %>%
  right_join(Q6_Chronic_Pain_ids_we_want)
```
...
write.csv(Q53_plot, 'Q53_Filtered_Q6_80.277.csv', row.names = FALSE)
write.csv(Q53_respondents, 'Q53_Filtered_Q6_Responses_ID.csv', row.names = FALSE)
```