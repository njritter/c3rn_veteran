---
title: "q102 'Do you believe the VA should offer free (or discounted) medical cannabis to veterans who qualify for its use?' (Veterans)"
author: "David Ritter"
...
q102_general <- get_single_selection(data = raw_data_general, q.name = q103)
q102_bask <- get_single_selection(data = raw_data_bask, q.name = q103)
q102_botanist <- get_single_selection(data = raw_data_botanist, q.name = q103)
...
write.csv(q102_plot, 'q102_vet_cannabis_discount_201.csv', row.names = FALSE)
