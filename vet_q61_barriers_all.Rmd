...
Q61_general <- get_single_selection(data = raw_data_general, q.name = Q61)
Q61_botanist <- get_single_selection(data = raw_data_botanist, q.name = Q61)
Q61_healing_rose <- get_single_selection(data = raw_data_healing_rose, q.name = Q61)
Q61_bask <- get_choose_all(raw_data_bask, q.name = Q61, f.response = Q61_final_response)

Q61_all <- 
  rbind(Q61_bask, Q61_general, Q61_botanist, Q61_healing_rose) %>%
  tidy_choose_all()
...
write.csv(Q61_plot, 'bask_q61_barriers_19.34.csv', row.names = FALSE)
