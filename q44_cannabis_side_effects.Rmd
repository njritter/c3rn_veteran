...
write.csv(q_plot, 'output/q44_cannabis_side_effects_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q44_cannabis_side_effects.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q44_cannabis_side_effects_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q44_cannabis_side_effects_ids.csv', row.names = FALSE)
```
