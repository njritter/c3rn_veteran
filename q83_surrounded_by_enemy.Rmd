...
r <- 
  ...
  labs(title = "Were you ever surrounded by the enemy?", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q83_surrounded_by_enemy_90.csv', row.names = FALSE)

write.csv(q_data, 'q83_surrounded_by_enemy_ids.csv', row.names = FALSE)
```
