...
ggsave(filename = 'OCCP_Q4_Cannabis_Use.png', plot = r, device = 'png')

write.csv(Q4_plot, 'OCCP_Q4_Cannabis_Use_900_900.csv', row.names = FALSE)

write.csv(Q4_clean, 'OCCP_Q4_Cannabis_Use_Responses_ID.csv', row.names = FALSE)
```