---
title: "q39 'What is the primary health condition for which you find cannabis to be helpful? (Please select one)' (National Veterans)"
author: "DJ"
...
write.csv(q39_plot, 'q39_top_condition_cannabis_431.csv', row.names = FALSE)
