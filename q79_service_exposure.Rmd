...
r <- 
  ...
  labs(title = "Were you exposed to any of the following during your service? (Please select all that apply)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q79_service_exposure_214.csv', row.names = FALSE)
