...
write.csv(q_plot, 'output/q61_barriers_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q61_barrers.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q61_barrers_232.csv', row.names = FALSE)
write.csv(qf_data, 'output/q61_barrers_ids.csv', row.names = FALSE)
```