---
title: "Q45 Prescriptions Reduced Cannabis (Filtered) (Veterans)"
author: "DJ"
date: "July 29, 2019"
...
Q45_all_reduce <-
   ...
   filter(chosen != "I donÂ???TTt take any medications")
...
ggsave(filename = 'vet_q45_prescriptions_reduced_cannabis_filtered.png', plot = r, device = 'png')

write.csv(Q45_plot, 'vet_q45_prescriptions_reduced_cannabis_filtered_125.305.csv', row.names = FALSE)

write.csv(Q45_all_reduce, 'vet_q45_prescriptions_reduced_cannabis_filtered_ids.csv', row.names = FALSE)
```
