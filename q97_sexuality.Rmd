...
r <- 
  ...
  labs(title = "Do you consider yourself to be any of the following?", subtitle = q_n)
r
```

```{r}
# Save graph as PNG, plot data as csv, and all question data including response IDs as csv (save question n and N at end of plot file as "_x.x")
ggsave(filename = 'q97_gender_identity.png', plot = r, device = 'png')

write.csv(q_plot, 'q97_gender_identity_217.csv', row.names = FALSE)

write.csv(q_data, 'q97_gender_identity_ids.csv', row.names = FALSE)
```
