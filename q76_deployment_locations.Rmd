...
write.csv(q_plot, 'output/q76_deployment_locations_144.csv', row.names = FALSE)
...
```{r}
ggsave(filename = 'output/q76_deployment_locations.png', plot = r, device = 'png')
write.csv(q_plot, 'output/q76_deployment_locations_232.csv', row.names = FALSE)
write.csv(qf_all_data, 'output/q76_deployment_locations_ids.csv', row.names = FALSE)
```
