...
r <- 
  ...
  labs(title = "Where were you deployed/stationed? (Please select all that apply)", subtitle = q_n)
r
```
...
write.csv(q_plot, 'q76_deployment_locations_217.csv', row.names = FALSE)
