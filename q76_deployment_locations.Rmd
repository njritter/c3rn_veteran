...
write.csv(q_plot, 'q76_deployment_locations_144.csv', row.names = FALSE)
write.csv(q_data, 'q76_deployment_locations_ids.csv', row.names = FALSE)
```
...
```{r}
ggsave(filename = 'q76_deployment_locations.png', plot = r, device = 'png')
write.csv(q_plot, 'q76_deployment_locations_n#.csv', row.names = FALSE)
write.csv(qf_data, 'q76_deployment_locations_ids.csv', row.names = FALSE)
```
